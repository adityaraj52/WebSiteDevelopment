...
<center>
<div id="meer" style="width:720px;background-color:#0080AA;height:710px;margin-top:20px">
<form action="updateinf.php" method="post">
...
<tr style="font-size:25;color:#ffffff;height:60">
<th width="360" height="20">Add2Cart</th>
<th width="360" height="20">
<select name="f9" style="width:260px;font-size:17pt">
  <option value="1">1 IPHONE</option>
  <option value="2">2 Samsung GALAXY</option>
  <option value="3">3 HTC DESIRE</option>
  <option value="4">4 LG NEXUS</option>
  <option value="5">5 DELL</option>
  <option value="6">6 INTEL</option>
  <option value="7">7 IBALL</option>
  <option value="8">8 VIRGIN MOBILE</option>
</select></tr>

<tr style="font-size:25;color:#ffffff;height:60">
<th width="360" height="20">Product Quantity</th>
<th width="360" height="20"><input type="text" style="font-size:17pt" maxlength="10" name="f10" value="1" </th>
</tr>
