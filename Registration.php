...
<a href="Registration.php" style="text-decoration:none;"><span><font size=5px color=#000000>Premier Login/</font</a>
<a href="Registration.php" style="text-decoration:none;">
<font size=5px color=#000000>Signup</font></span></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font size=4px color=#000000>
<form name="form1" action="Reg_updat.php" onsubmit="return validateform()" style="display:inline" method="post">

<b>E-mail </b><font><input type="Email" id="txtEmail" style="font-size:10pt" size= "15" maxlength="40" name="fname1" required placeholder="E-mail">
<b>Password </b><font><input type="password" style="font-size:10pt"; size="15" maxlength="6" name="fname2" placeholder="Secure Key">

<input type="submit" ondblclick="alert('Not Allowed')" style="font-size:13pt";size="10";value="Submit">
</form>
</h4>

<div id="none" style= "background-color:#0080FF;HEIGHT:50PX;width:940px;margin-left:0px;"><div id="none" style= "background-color:#0080FF;HEIGHT:50PX;width:940px;margin-left:400px;"><div style="margin-top:12px;float:left"><font size="5px"><a href="Main.php" style="text-decoration: none ;color:#ffffff;">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Aboutus.php" style="text-decoration:none;color:#ffffff">About Us</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="gallery.php" style="text-decoration: none;color:#ffffff">Gallery</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="contactus.php" style="text-decoration: none;color:#ffffff">Contact Us</a>
</div></div></div>
...
<div  style="background-color:#D8D8C7;width:10cm;height:800px;margin-top:40px;margin-left:2cm;float:left">

<div  style="background-color:#D8D8C7;width:9cm;height:750px;margin-top:40px;margin-left:0.5cm;float:left">
...
<table>
<tr>
<td><input type="text" style="font-size:14pt"; size= "10" name="a1" required placeholder="First"></td>
<td><input type="text" style="font-size:14pt"; size= "10" name="a2" required placeholder="Last"></td>
</tr>
</table>

<br>
<font size="4"><b>Choose your username</b></font><br>
<input type="email" id="txtEmail" style="font-size:14pt"; size= "27" maxlength="40" name="a3" required placeholder="E-mail"><br><br>
<font size="4"><b>Create a password:<br></b><input type="password" maxlength="6" style="font-size:14pt"; size="27" name="a4" required placeholder="Enter Password">

<font size="4"><br><br><b>Confirm your password:</b><br><input type="password" maxlength="6" style="font-size:14pt"; size="27" name="zz" required placeholder="Re-Enter Password"><br>


<br>

<font size="4"><b>Birthday</b><br><input type="date" name="a5" style="width:260px;font-size:14pt" required><br>
<br><font size="4"><b>Model Interested</b><br>
<select name="a6" style="width:260px;font-size:14pt">
...
<select name="a7" style="width:260px;font-size:14pt">
...
<input type="text" name="a8" style="font-size:14pt"; size= "27" maxlength="10"  height="4"   required placeholder="+91 ">
