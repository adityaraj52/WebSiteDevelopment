...
<h4>Buy Online or Call 1-800-425-4026 or 080-2506-8026&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Registration.htm" style="text-decoration:none;"><span><font size=5px color=#000000>Premier Login/</font</a><a href="Registration.htm" style="text-decoration:none;"><font size=5px color=#000000>Signup</font></span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font size=4px color=#000000>
<?php
...
<div id="none" style= "background-color:#0080FF;HEIGHT:50PX;width:940px;margin-left:0px;"><div id="none" style= "background-color:#0080FF;HEIGHT:50PX;width:940px;margin-left:400px;"><div style="margin-top:12px;float:left"><font size="5px"><a href="Main.htm" style="text-decoration: none ;color:#ffffff;">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Aboutus.htm" style="text-decoration:none;color:#ffffff">About Us</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="gallery.html" style="text-decoration: none;color:#ffffff">Gallery</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="contactus.htm" style="text-decoration: none;color:#ffffff">Contact Us</a>
</div></div></div>
...
$(document).ready(function(){
	$("#Dateis").mouseenter(function(){
	document.getElementById("Dateis").innerHTML=Date();})

})
</script>
<script>
$(document).ready(function(){
	$("#Dateis").mouseleave(function(){
		document.getElementById("Dateis").innerHTML="Mouseover for Time  !"})
})
</script>
<script>
...
<form name="form2"  action="html_form_action.asp" onsubmit="return validateform2(form2)" method="post">
...
<input type="tel" style="font-size:14pt"; size= "27" maxlength="10" minlength="10" height="4" name="a10"  required placeholder="+91 ">
